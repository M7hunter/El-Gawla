...
public class AccountDetails extends AppCompatActivity {
    ...
    private void getData() {
        ...
        try {
            Picasso.with(AccountDetails.this)
                    .load(SharedPrefManager.getInstance(AccountDetails.this).getUserImage())
                    .placeholder(AccountDetails.this.getResources().getDrawable(R.drawable.placeholder))
    ...
    private void getImageUri(Intent data) {
        ...
        try {
            ...
            Picasso.with(AccountDetails.this).load(imagePath).into(img_update_image);
            Bitmap bitmap = MediaStore.Images.Media.getBitmap(AccountDetails.this.getContentResolver(), imagePath);
            ...
            Toast.makeText(AccountDetails.this, e.getMessage(), Toast.LENGTH_SHORT).show();
        }
    ...
    private void UploadImage(final String encodedImage) {
        ...
        new Thread(new Runnable() {
            @Override
            public void run() {
                user_id = SharedPrefManager.getInstance(AccountDetails.this).getUser().getUser_id();
                api_token = SharedPrefManager.getInstance(AccountDetails.this).getUser().getApi_token();
                RetrofitClient.getInstance(AccountDetails.this).executeConnectionToServer("updateUserData", new Request(user_id, api_token, encodedImage), new HandleResponses() {
                    @Override
                    public void handleResponseData(JsonObject mainObject) {
                        ...
                        String message = mainObj.get("message").getAsString();
                            ...
                            SharedPrefManager.getInstance(AccountDetails.this).saveUserImage(image);
                    ...
                    public void handleConnectionErrors(String errorMessage) {
                        ...
                        Toast.makeText(AccountDetails.this, errorMessage, Toast.LENGTH_SHORT).show();
                    }
                });
            }
        }).start();
