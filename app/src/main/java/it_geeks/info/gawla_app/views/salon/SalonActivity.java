...
import static it_geeks.info.gawla_app.util.Constants.REQ_GET_SALON_WITH_REALTIME;
import static it_geeks.info.gawla_app.util.Constants.REQ_GET_USER_CARDS_BY_SALON;
import static it_geeks.info.gawla_app.util.Constants.REQ_GET_TOP_TEN;
import static it_geeks.info.gawla_app.util.Constants.REQ_GET_WINNER;
import static it_geeks.info.gawla_app.util.Constants.REQ_SET_USER_OFFER;
import static it_geeks.info.gawla_app.util.Constants.REQ_SET_USER_SALON;
import static it_geeks.info.gawla_app.util.Constants.REQ_SET_ROUND_LEAVE;
import static it_geeks.info.gawla_app.util.Constants.REQ_USE_GOLDEN_CARD;
